    ...
    >
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }} >
        ...
        <Box sx={{ display: { xs: 'none', md: 'flex' }, gap: 1 }}>
          {/* màn hình xs:none:ẩn đi */}
          {/* màn hình từ md trở lên: hiện ra-doc of MUI */}
          <WorkSpaces />
          <Recent />
          <Starred />
          <Templates />
          ...
          InputProps={{
            ...
            endAdornment: (
              <CloseIcon
                ...
                onClick={() => setSearchValue('')} //set cho value vừa nhập mà dc click vào closeIcon thì sẽ clear về ''
              />
            )
          }}
          sx={{
